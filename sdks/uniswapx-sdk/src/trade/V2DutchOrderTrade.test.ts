import { Currency, Ether, Token, TradeType } from "@nizaglobal/sdk-core";
...
describe("V2DutchOrderTrade", () => {
  ...
  const orderInfo: UnsignedV2DutchOrderInfo = {
  ...
  const trade = new V2DutchOrderTrade<Currency, Currency, TradeType>({
    currencyIn: USDC,
    currenciesOut: [DAI],
    orderInfo,
