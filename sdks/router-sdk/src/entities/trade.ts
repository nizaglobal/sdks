import { Currency, CurrencyAmount, Fraction, Percent, Price, TradeType } from '@nizaglobal/sdk-core'
import { Pair, Route as V2RouteSDK, Trade as V2TradeSDK } from '@nizaglobal/v2-sdk'
import { Pool, Route as V3RouteSDK, Trade as V3TradeSDK } from '@nizaglobal/v3-sdk'
...
export class Trade<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
  ...
  public constructor({
    ...
    for (const { routev2, inputAmount, outputAmount } of v2Routes) {
      const route = new RouteV2(routev2) as unknown as IRoute<TInput, TOutput, Pair | Pool>
  ...
  public static async fromRoutes<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(
    ...
    for (const { routev2, amount } of v2Routes) {
      const v2Trade = new V2TradeSDK(routev2, amount, tradeType as any)
  ...
  public static async fromRoute<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(
    ...
    if (route instanceof V2RouteSDK) {
      const v2Trade = new V2TradeSDK(route, amount, tradeType as any)
      const { inputAmount, outputAmount } = v2Trade
